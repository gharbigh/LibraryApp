...
public interface Library {
     ...
     * @see Member
     */
    Book borrowBook(long isbnCode, Member member, LocalDate borrowedAt) throws HasLateBooksException, BookException, MemberException, BookIsNotAvailable;
     ...
     */
    void returnBook(Book book, Member member) throws BookException, MemberException;
